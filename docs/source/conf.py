...
htmlhelp_basename = 'rstdocgendoc'
...
latex_documents = [
    (master_doc, 'rstdocgen.tex', 'rstdocgen Documentation',
     [author], 'manual'),
]
...
man_pages = [
    (master_doc, 'rstdocgen', 'rstdocgen Documentation',
     [author], 1)
]
